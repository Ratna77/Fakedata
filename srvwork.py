You have helped me to created the masking its working fine there is one issue will give you deatil example just bursh up the script will later chat will give you the example
######################script
import pandas as pd
